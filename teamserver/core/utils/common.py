...
def banner():
    ...
    logo = rf"""{Fore.BLUE}{Style.BRIGHT}
                         __
           ---_ ...... _/_ -
          /  .      ./ .'*\ \
          : '         /__-'   \.
     ...
     \           __/"     /.'
       \ '--  .-" /     //'
        \|  \ | /     //
             \:     //
          `\/     //
           \__`\/ /  {Style.RESET_ALL}{Fore.BLUE}{Style.BRIGHT}  PYBIT {Fore.YELLOW}C2
...
class Print_str:
    ...
    def info(self, msg):
        return f"{self.style.gray('[i]')} {msg}\n"

    def success(self, msg):
        return f"{self.style.light_green('[+]')} {msg}\n"

    def fail(self, msg):
        return f"{self.style.light_red('[-]')} {msg}\n"

    def warning(self, msg):
        return f"{self.style.light_yellow('[!]')} {msg}\n"

    def task(self, msg):
        return f"{self.style.light_blue('[*]')} {msg}\n"
